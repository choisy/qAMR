...
with(out2, plotllog(time, log10(pop_size), xaxs = "i",
                    xlab = "time", ylab = "log10(population size)"))
plotllog(out2$time, mean_resistance(out2),
         xlab = "time", ylab = "mean level of resistance")
plotllog(out2$time, resistance_variance(out2),
...
no_mutation <- simulator(size0, sigma0, pm, p0, p1, k0, k1, alpha, mu, 0, x, time)
