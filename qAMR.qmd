...
sim0 <- simulator(size0, x0, sigma0, pm, p0, p1, k0, k1, alpha, mu, eps, x, time) |> 
  log_transform()
...
y1 <- sim0$pop_size
y2 <- sim1$pop_size
plotllog1(x, y1, ylim = range(c(y1, y2)),
         xlab = "time", ylab = "population size")
lines2(x, y2)
...
plotllog1(sim0$time, sim0$pop_size, ylim = c(0, 4), yaxs = "i",
         xlab = "time", ylab = "population size")
...
sim0 <- simulator(size0, x0, sigma0, pm, p0, p1, k0, k1, alpha, mu, eps, x, time) |> 
  log_transform()
sim1 <- simulator(size0, x0, sigma0, pm, p0, p1, 0, 0, alpha, mu, eps, x, time) |> 
  log_transform()
...
sim0 <- simulator(size0, x0, sigma0, pm, p0, p1, k0, k1, alpha, mu, 0, x, time) |> 
  log_transform()
sim1 <- simulator(size0, x0, sigma0, pm, p0, p1, 0, 0, alpha, mu, 0, x, time) |> 
  log_transform()
